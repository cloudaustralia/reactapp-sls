...
def handler(event, context):
    ...
    event['execution_environment'] = os.getenv(
        "AWS_EXECUTION_ENV", 'no-executionenv')
    # Dump all environment variables for later reference...
    event['environ'] = json.dumps(dict(**os.environ))
